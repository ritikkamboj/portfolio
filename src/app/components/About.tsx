...
function About() {
  return (
    <div className="max-w-[1200px] mx-auto text-center" id="about">
      ...
      <div className="px-6 md:p-0 grid md:grid-cols-8 gap-6">
        <div className="w-full md:col-span-5 bg-white/10 background-blur-lg border border-white/20 rounded-xl relative">
        ...
        <div className="w-full md:col-span-3 bg-white/10 background-blur-lg border border-white/20 rounded-xl relative">
          <div className="absolute inset-0 bg-gradient-to-r from-orange-400 via-purple-700 to-orange-800 opacity-30 rounded-xl"></div>
